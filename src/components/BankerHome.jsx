...
const BankerHome = () => {
  ...
  return (
    <div className="bg-slate-500 min-h-[100vh] ">
      <h1 className="text-black text-3xl text-center">Welcome Banker</h1>
      <div className="text-black flex font-basker justify-start items-center py-2 px-1">
        <div className="flex w-full">
          ...
          <div className="w-4/5 flex justify-center items-center">
            {activeServiceButton ? (
              <div className=" w-full min-h-[90vh]  bg-slate-50 rounded-t-none rounded-b border-black border-x-2 border-b-2 flex justify-center items-start">
        ...
        <button
          className="text-black fixed  right-2 top-2"
